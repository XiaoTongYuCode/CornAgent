...
export function ProjectIntroduction({
  ...
  return (
    <section className={`project-introduction${compact ? ' project-introduction--compact' : ''}`} aria-label="CornAgent">
      ...
      <p>{translate(locale, compact || brief ? 'projectShortDescription' : 'projectDescription')}</p>
      {showLinks && <nav aria-label={translate(locale, 'projectLinks')}>
        ...
        <a className="project-listing-badge" href="https://aiagentslisting.com/cornagent">
          <img className="project-listing-badge__light" src="https://aiagentslisting.com/cornagent/badge.svg?theme=light" alt={translate(locale, 'projectListingBadge')} width="200" height="50" loading="lazy" />
          <img className="project-listing-badge__dark" src="https://aiagentslisting.com/cornagent/badge.svg?theme=dark" alt={translate(locale, 'projectListingBadge')} width="200" height="50" loading="lazy" />
        </a>
      </nav>}
    </section>
  )
