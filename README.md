...
| 暂停与恢复 | Agent 提问后等待用户；刷新页面或重启服务后可从安全检查点继续 |
...
PostgreSQL 是持久状态的事实来源。页面刷新后先恢复快照，再接续 SSE；服务重启后，后台协调器从安全检查点恢复。Redis 事件丢失不会删除已保存的会话。
...
<p align="center">
  Made by <a href="https://xiaotongyu.com">xiaotongyu.com</a>
</p>
